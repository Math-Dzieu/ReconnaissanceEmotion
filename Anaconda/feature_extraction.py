...
def addFeature(FileWithPath, saveName):
    ...
    listDistFeatureDistance=[2, 48, 14, 54, 48, 54, 8, 57, 50, 58, 52, 56, 33 ,51, 18, 37, 20, 38, 37, 41, 23, 43, 25, 44, 44, 46, 63, 65, 61, 67, 21, 27, 22, 27]
    ...
    listDistFeaturePente=[49, 48, 54, 53, 19, 21, 22, 24]
